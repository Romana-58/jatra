...
import { Mail, Lock, Train, UserIcon, Phone, CreditCard, ArrowRight } from "lucide-react"
      ...
      <div className="flex-1 flex items-center justify-center p-4 py-12">
        <div className="w-full max-w-2xl">
          <div className="mb-8 text-center">
            ...
            <p className="text-lg text-muted-foreground">Join thousands of travelers on Jatra Railway</p>
          </div>
